    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_content', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='author_content', to=settings.AUTH_USER_MODEL)),
                ('categories_content', models.ManyToManyField(related_name='categories', to='content.category')),
            ],
            options={
